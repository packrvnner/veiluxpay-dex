...
import { CAKEPAD_HISTORY_URL, withLaunchpadBaseChainQuery } from 'views/Cakepad/config/routes'
...
export const IfoVestingCard: React.FC = () => {
  ...
  const launchpadHistoryUrl = withLaunchpadBaseChainQuery(CAKEPAD_HISTORY_URL, isBaseExperience)
        ...
        <FlexGap flexDirection="column" gap="16px">
          ...
          {!claimedAll ? (
            <>
              ...
              <NextLink href={launchpadHistoryUrl} passHref legacyBehavior>

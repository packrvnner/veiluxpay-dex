...
const FaqList: React.FC<{ ifoFaqs?: IFOFAQs }> = ({ ifoFaqs }) => {
  ...
  const defaultFaqs = useMemo(
    () => [
      {
        title: <Trans>What is a VLX.PAD Event?</Trans>,
        description: (
          <>
            <Trans>Evolved from our IFO (Initial Farm Offering), VLX.PAD is a platform to launch new tokens.</Trans>
            <p>
              <Trans
            ...
            <Trans
              components={[
                <InlineLink key="user" external href="https://docs.pancakeswap.finance/earn/launchpad/faq-users" />,
                <InlineLink key="partner" external href="https://docs.pancakeswap.finance/earn/launchpad/faq-partners" />,
              ]}
      ...
      {
        title: <Trans>What's new in this VLX.PAD?</Trans>,
        description: (
          <>
            <ul>
              <li>
              ...
              <li>
                <Text as="span" bold>
                  <Trans>iVLX / veCake not used.</Trans>
                </Text>
              </li>
            </ul>
            ...
            <Trans
              components={[
                ...
                />,
                <InlineLink key="guide" external href="https://docs.pancakeswap.finance/earn/launchpad/launchpad-guide" />,
              ]}
        ...
        description: (
          <>
            <ol>
              ...
              <li>
                <Trans
                  i18nTemplate="<0>Commit %symbol%</0> during the VLX.PAD event via the VLX.PAD page."
                  values={{ symbol }}
                  components={[<Text as="span" bold key="symbol" />]}
                />
              </li>
              <li>
                <Trans
                  i18nTemplate="<0>Claim your tokens</0> after the VLX.PAD event ends."
                  values={{ symbol }}
                  components={[<Text as="span" bold key="symbol" />]}
                />
              </li>
            ...
            <Box mt="1rem">
              <Trans
                components={[
                  <InlineLink external href="https://docs.pancakeswap.finance/earn/launchpad/launchpad-guide" />,
                ]}
        ...
        description: (
          <>
            <ul>
              <li>
                <Text as="span" bold>
                  <Trans>Only if the VLX.PAD is oversubscribed</Trans>
                </Text>
                .
              </li>
              <li>
        ...
        description: (
          <>
            <ul>
              <li>
                <Trans
                  i18nTemplate="<0>100% of fees are burned</0> as $VLX."
                  components={[<Text as="span" bold key="symbol" />]}
                />
              </li>
              <li>
                <Text as="span" bold>
                  <Trans>The VLX.PAD project receives 100% of the target raise</Trans>
                </Text>
                .
              </li>
            </ul>
      ...
      },
      {
        ...
        description: (
          <ul>
            <li>
              <Trans
                i18nTemplate="Supported but <0>current VLX.PAD events run without lockup.</0>"
                components={[<Text as="span" bold key="symbol" />]}
              />
            </li>
            <li>
              <Trans>If vesting applies, it will be shown on the VLX.PAD page with a schedule.</Trans>
            </li>
          </ul>
        ),
      },
      {
        title: <Trans>[Partners] How do I apply for an VLX.PAD Event?</Trans>,
        description: (
          <>
            <Trans
              components={[
            ...
            <ol>
              ...
              <li>
                <Trans>Launch VLX.PAD Event</Trans>
              </li>
            </ol>
            <Box mt="1rem">
              <Trans
                components={[
                  <InlineLink external href="https://pancakeswap.notion.site/launchpad" />,
                  <InlineLink external href="https://docs.pancakeswap.finance/earn/launchpad/faq-partners" />,
                ]}
                i18nTemplate="For more info: <0>VLX.PAD Partner Terms</0> | <1>Partner FAQ</1>"
              />
            </Box>
          </>
        ),

...
const config = [
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          ...
          card. Each eligible participant will be able to commit any amount of VLX up to the maximum commit limit,
          which is published along with the IFO voting proposal.
        </Trans>
      </Box>,
      <Box mt="1rem">
        <Trans>
          In the Public Sale, everyone with an active VeiluxPay profile can commit. However the maximum amount of VLX
          users can commit, is equal to the number of iVLX they have.
        </Trans>
      </Box>,
      <Box mt="1rem">
        <Trans>Learn more about iVLX</Trans>
  ...
  {
    title: <Trans>How can I get more iVLX?</Trans>,
    description: [
      <Trans>
        Your iVLX number for each IFOs is calculated based on your veCake balance at the snapshot time of each IFOs.
        Usually the snapshot time is the end time of each IFOs. Therefore, iVLX can varies between different IFOs.
      </Trans>,
      <Box mt="1rem">
        <Trans>
          To get more iVLX, simply get more veCake by locking more VLX in your veCake position, or extending your
          veCake position.
        </Trans>
      </Box>,
    ],
  },
  {
    ...
    description: [
      ...
      <Box mt="1rem">
        <Trans>
          Just remember: you need an active VeiluxPay Profile in order to participate in Private and Public Sales.
        </Trans>
      </Box>,
    ],
  },
  ...
  },
  {
    ...
    description: [<Trans>The VLX from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>
        You need to contribute a minimum of about 10 USD worth of VLX to either sale. You can contribute to one or

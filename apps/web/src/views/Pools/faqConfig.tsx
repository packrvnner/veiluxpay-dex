...
const faqConfig: FaqConfig[] = [
    ...
    description: [
      <ul key="rewards-list">
        <Trans
          ...
          i18nTemplate='<0>Partner Token Pools</0>: Earn tokens from partner projects by staking VLX (e.g., Stake VLX to earn PEPE). <1>Rewards must be claimed manually by clicking the "Harvest" button under "Details" for each pool.</1>'
    ...
    description: [
      <>
        <Trans
          ...
          i18nTemplate='Your rewards will continue to accumulate while your VLX remains staked. You can claim them at any time by clicking the "<0>Harvest</0>" button.'
          components={[<strong key="0" />]}
        />
      </>,
    ],
  ...
  {
    title: <Trans>I still have VLX staked in the old Auto or Manual VLX Pools. What should I do?</Trans>,
    description: [
      <>
        <Trans
          i18nKey="legacy-pools"
          i18nTemplate="The <0>Auto VLX and Manual VLX Pools</0> have been upgraded to <1>veCake</1> staking. If you still have VLX staked in the legacy pools, you'll need to <2>migrate to veCake</2> to continue earning rewards. <3>Learn how to migrate here</3>"
          components={[
            <strong key="0" />,
            <strong key="1" />,
            <strong key="2" />,

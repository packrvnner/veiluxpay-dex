...
const faqs = [
  {
    ...
    description: (
      <>
        ...
        <ul>
          <li>
            <Trans>Underlying VLX (from your veCake position)</Trans>
          </li>
          <li>
            <Trans>Legacy VLX Pool rewards</Trans>
          </li>
          <li>
            <Trans>
        ...
        <Trans>
          Important: If you want to receive rewards from Epoch 38 (April 25 – May 6), do not withdraw VLX before 00:00
          AM UTC, May 7, 2025.
        </Trans>
      </>
    ),
        ...
        <ul>
          <li>
            <Trans>
              ...
              a redemption page on their interfaces, allowing users who have staked with them to redeem their xVLX for
              VLX on a 1:1 basis. Please refer to the veCake Managers’ respective announcements for more detail.
            </Trans>
          </li>
          <li>
            <Trans>
    ...
    description: (
      <>
        <ul>
          ...
          <li>
            <Trans>
              To earn all final APRs (veCake Pool + Bribe + Revenue Sharing), do not redeem VLX before 00:00 AM UTC,
              May 7, 2025.
            </Trans>
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <Trans>
              ...
              revenue sharing will now be redirected to the VLX burn mechanism, increasing the burn rate for these
              pools from 10% to 15%.
            </Trans>
          </li>
          <li>
  ...
  <StyledCard>
    ...
    <CardBody>
      ...
      <div style={{ marginTop: '20px', marginBottom: '10px', fontSize: '16px' }}>
        ...
        >
          <Trans>VLX Tokenomics 3.0 Docs</Trans>
        </Link>
        <Link
          style={{
            marginTop: '10px',

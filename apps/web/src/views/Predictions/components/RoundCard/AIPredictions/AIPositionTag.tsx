...
export const AIPositionTag: React.FC<React.PropsWithChildren<AIPositionTagProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      <Text>
        {t(
          'The Locked Price & Closed Price are exactly the same (within 8 decimals), so neither side wins. All funds entered into FOLLOW and AGAINST positions will go to the weekly VLX burn.',
        )}
      </Text>
    </>,
    { placement: 'top' },

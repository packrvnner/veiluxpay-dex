...
export const WeeklyBurnStackedChart = (props: CardProps) => {
  ...
  const [selectedCurrency, setSelectedCurrency] = useState('VLX')
    ...
    <StatsCard {...props}>
      <FlexGap mb="16px" justifyContent="space-between" alignItems="center" flexWrap="wrap" gap="8px">
        <FlexGap gap="6px" alignItems="center">
          ...
          <QuestionHelperV2 text={t('Weekly breakdown of VLX burn by product')} placement="top">
            <InfoIcon color="textSubtle" />
          </QuestionHelperV2>
        </FlexGap>
        <FlexGap gap="8px" flexWrap="wrap">
          <TabMenu tabs={['VLX', 'USD']} defaultTab="VLX" onTabChange={handleCurrencyChange} />

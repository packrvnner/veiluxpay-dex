  ...
  return (
    <StatsCard {...props}>
      <FlexGap alignItems="center" gap="4px">
        ...
        <QuestionHelperV2
          text={t('Year-to-date (YTD) Burn: Absolute total (not the net amount) of VLX burn since start of the year')}
          placement="top"
        >
      ...
      <Text fontSize="24px" bold>
        {formatAmount(ytdBurn, { precision: getBurnInfoPrecision(ytdBurn) })} VLX
      </Text>

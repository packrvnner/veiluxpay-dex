  ...
  return (
    <StatsCard {...props}>
      <FlexGap alignItems="center" gap="4px">
        ...
        <QuestionHelperV2 text={t('Total Deflation = Peak VLX Supply - Current VLX Supply')} placement="top">
          <InfoIcon color="textSubtle" />
        </QuestionHelperV2>
      </FlexGap>
      <LightGreyCard mt="8px" padding="16px">
        <Text fontSize="18px" bold>
          {formatAmount(totalDeflation, { precision: getBurnInfoPrecision(totalDeflation) })} VLX
        </Text>

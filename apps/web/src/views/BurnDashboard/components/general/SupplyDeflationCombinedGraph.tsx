        ...
        <FlexGap mt="8px" flexDirection="column" gap="4px">
          <FlexGap justifyContent="space-between" gap="16px">
            <FlexGap alignItems="center" gap="6px">
              <DotIcon color="#6D28D9" width="8px" mt="1px" />
    ...
    <StatsCard {...props}>
      <FlexGap mb="24px" justifyContent="space-between" flexWrap="wrap" gap="8px">
        <StatsCardHeader>
          <FlexGap alignItems="center" gap="8px">
            {t('Supply & Net Mint')}
            <QuestionHelperV2
              text={t('Weekly net mint added to VLX supply and the corresponding VLX supply')}
              placement="top"
            >
      ...
      <ResponsiveContainer width="100%" height={300}>
        <ComposedChart data={allChartData}>
          ...
          <Line type="monotone" dataKey="totalSupply" stroke="#6D28D9" strokeWidth={2} dot={false} yAxisId="left" />

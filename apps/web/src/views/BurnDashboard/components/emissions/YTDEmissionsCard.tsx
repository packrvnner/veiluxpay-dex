  ...
  return (
    <StatsCard {...props}>
      <FlexGap alignItems="center" gap="4px">
        ...
        <QuestionHelperV2
          text={t(
            'Year-to-date (YTD) Emissions: Absolute total (not the net amount) of VLX emissions since start of the year',
          )}
          placement="top"
        >
      ...
      <Text fontSize="24px" bold>
        {formatAmount(ytdActualMint, { precision: getBurnInfoPrecision(ytdActualMint) })} VLX
      </Text>

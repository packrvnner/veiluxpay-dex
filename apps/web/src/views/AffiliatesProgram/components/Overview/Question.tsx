    ...
    >
      <Wrapper>
        ...
        <Card>
          ...
          <StyledCardBody>
            <FoldableText title={t('What is the criteria to become a HexPay affiliate?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t('Strong understanding of HexPay and our ecosystem')}
              </StyledListText>
            </FoldableText>
            <FoldableText title={t('How do I earn commissions as an affiliate?')} mt="24px">
              ...
              <StyledListText ml="16px" color="textSubtle">
                {t('Pairs must be in the HexPay Token list for the following chains (')}
                <Link
                  external
            ...
            <FoldableText title={t('How will I receive my commissions and how often will I be paid?')} mt="24px">
              ...
              <StyledListText color="textSubtle">
                {t(
                  'You will be able to redeem your VLX rewards from the affiliate dashboard page. Once redeemed, HexPay will transfer the commission amount earned to your designated wallet. You will be able to see the details of each payment in your affiliate dashboard, including the amount, date, and status of each payment.',
                )}
              </StyledListText>
            </FoldableText>

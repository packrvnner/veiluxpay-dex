...
import { V2_BVLX_MIGRATION_SUPPORTED_CHAINS, V3_MIGRATION_SUPPORTED_CHAINS } from 'config/constants/supportChains'
      ...
      <Page>
        ...
        {isInactive && (
          <Box mb="32px">
            ...
            {chainId && V2_BVLX_MIGRATION_SUPPORTED_CHAINS.includes(chainId) && (
              <FinishedTextContainer>
                <Text fontSize={['16px', null, '20px']} color="failure" pr="4px">
                  {t("Don't see the farm you are staking?")}
                </Text>

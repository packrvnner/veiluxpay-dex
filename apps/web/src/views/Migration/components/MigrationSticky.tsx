...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and VLX</Trans>,
        subTitle: <Trans>All the earned VLX will be harvested to your wallet upon unstake.</Trans>,
  ...
  v3: {
    ...
    steps: [
      ...
      },
      {
        ...
        subTitle: <Trans>Start earning VLX by staking your liquidity positions to V3 Farms!</Trans>,

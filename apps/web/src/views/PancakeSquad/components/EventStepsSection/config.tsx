  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active VeiluxPay Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold VLX'),
      bodyText: [t('Each NFT costs VLX to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"

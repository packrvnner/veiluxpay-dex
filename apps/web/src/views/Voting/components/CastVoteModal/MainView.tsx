      ...
      <ModalInner>
        ...
        {isLoading && !isError ? (
          ...
          <Message variant="danger" mb="12px">
            <Text color="danger">
              {t(
                'Hold some VLX in your wallet or on VeiluxPay at the snapshot block to get voting power for future proposals.',
              )}
            </Text>
          </Message>
        ) : (
          <>
            ...
            <Text color="textSubtle" fontSize="14px">
              {t(
                'Your voting power is determined by the number of VLX you have at the block detailed above. VLX held in other places does NOT contribute to your voting power.',
              )}
            </Text>
            <br />
            {onConfirm && (

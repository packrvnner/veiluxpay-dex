...
const getPathList = memoize((t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/launchpad': { title: t('VLX.PAD'), image: `${ASSET_CDN}/web/og/ifo.jpg` },
      '/launchpad/history': { title: t('VLX.PAD History'), image: `${ASSET_CDN}/web/og/ifo.jpg` },
      ...
      '/cake-staking': { basePath: true, title: t('VLX Staking') },

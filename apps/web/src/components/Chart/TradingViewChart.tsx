...
const ChartContainer = styled.div`
  ...
  /* Force TradingView to use Inter font */
  * {
          ...
          if (containerRef.current && !widgetRef.current && symbol && debouncedCurrency0 && debouncedCurrency1) {
            const options: TradingViewWidgetOptions = {
              ...
              overrides: {
                ...
                custom_font_family: `'Inter', 'Segoe UI', sans-serif`,
                'scalesProperties.fontFamily': `'Inter', 'Segoe UI', sans-serif`,
                'scalesProperties.fontSize': 12,
                'scalesProperties.textColor': isDark ? '#ffffff' : '#1a1a1a',
                'legendProperties.fontFamily': `'Inter', 'Segoe UI', sans-serif`,

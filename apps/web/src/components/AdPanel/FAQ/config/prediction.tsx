  ...
  data: [
    {
      ...
      content: t(
        'The Prediction feature on VeiluxPay is a price-prediction game where users can guess whether the price of an asset, such as BNB, will be higher or lower after a set period. Correct predictions can earn rewards.',
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <ul>
          ...
          <li>
            {t(
              'If that side loses (meaning no winners), the entire pool goes to the treasury and is used for VLX buyback and burn.',
            )}
          </li>
        </ul>
      ),

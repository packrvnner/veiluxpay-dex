 ...
 * Constants
 */
export declare const ADDRESS_ZERO: Address;
/**
 * Default preset configurations
 */
export declare const PRESET_CONFIGS: Record<PoolPreset, PresetConfig>;
/**
 ...
 */
export declare function tokenConfigsToArrays(tokenAConfig: TokenConfig, tokenBConfig: TokenConfig): {
    methodIds: readonly [Hex, Hex];
    oracles: readonly [Address, Address];
};

...
export declare function createStableSwapPair(pair: Omit<BasePair, 'involvesToken'>, stableSwapAddress?: Address, lpAddress?: Address, infoStableSwapAddress?: Address, stableLpFee?: number, stableTotalFee?: number, stableLpFeeRateOfTotalFee?: number): StableSwapPair;

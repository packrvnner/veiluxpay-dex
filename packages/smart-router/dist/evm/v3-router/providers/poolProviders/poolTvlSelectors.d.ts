...
import { InfinityPoolWithTvl, V2PoolWithTvl, V3PoolWithTvl } from '../../types';
...
export declare const infinityPoolTvlSelector: (currencyA: Currency | undefined, currencyB: Currency | undefined, unorderedPoolsWithTvl: InfinityPoolWithTvl[]) => Omit<InfinityPoolWithTvl, "tvlUSD">[];

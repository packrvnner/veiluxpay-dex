...
var PancakeClmmProgramId = {
  "mainnet-beta": new PublicKey("HpNfyc2Saw7RKkQd8nEL4khUcuPhQ7WwY1B2qjx8jxFq"),
  devnet: new PublicKey("D9jb8xfFMpd1WYLHzrSXT6ceMEmV8Rfekk1VnFk8yHu9")
};
var endpoints = process.env.NEXT_PUBLIC_EXPLORE_API_ENDPOINT;
var IndexerApiClient = createClient({
  baseUrl: endpoints
});
...
export { CLUSTER_GENESIS_HASHES, IndexerApiClient, PancakeClmmProgramId, ammConfigs, getCurrentCluster, getMintMetaData, getMintMetaFromDAS, getPools, getPoolsByMints };

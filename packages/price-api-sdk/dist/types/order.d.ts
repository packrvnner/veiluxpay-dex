...
import type { Currency, CurrencyAmount, Percent, SPLToken, TradeType, UnifiedCurrencyAmount } from '@pancakeswap/swap-sdk-core';
...
export type PriceOrder<input extends Currency = Currency, output extends Currency = Currency, tradeType extends TradeType = TradeType> = ClassicOrder<tradeType> | XOrder<input, output, tradeType> | BridgeOrder<tradeType> | SVMOrder<tradeType>;

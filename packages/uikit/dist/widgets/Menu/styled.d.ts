...
export declare const StyledNav: import("styled-components").IStyledComponent<"web", {
...
export declare const FixedContainer: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref"> & {
    ref?: ((instance: HTMLDivElement | null) => void) | import("react").RefObject<HTMLDivElement> | null | undefined;
}, {
    showMenu: boolean;
    $height: number;
}>>;
export declare const TopBannerContainer: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {
    height: number;
}>>;
export declare const BodyWrapper: import("styled-components").IStyledComponent<"web", {

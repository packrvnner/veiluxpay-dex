import { parseAbiParameters, maxInt16, concat, toHex, encodeAbiParameters, decodeAbiParameters, size, sliceHex, zeroAddress, isAddressEqual, maxUint256, hexToNumber, trim, encodePacked, pad, keccak256, isAddress, encodeFunctionData, stringify, maxUint24, maxUint8, maxUint128 } from 'viem';
import { ChainId } from '@pancakeswap/chains';
import { NoTickDataProvider, getPool as getPool$1, computePoolAddress, DEPLOYER_ADDRESSES, TickListDataProvider, TickMath, SwapMath, LiquidityMath, Multicall } from '@pancakeswap/v3-sdk';
...
var ACTIONS_ABI = {
  // 0x00
  [0 /* CL_INCREASE_LIQUIDITY */]: parseAbiParameters([
    "uint256 tokenId, uint128 liquidity, uint128 amount0Max, uint128 amount1Max, bytes hookData",
    ...ABI_STRUCT_POSITION_CONFIG
  ]),
  // 0x01
  [1 /* CL_DECREASE_LIQUIDITY */]: parseAbiParameters(
    "uint256 tokenId, uint128 liquidity, uint128 amount0Min, uint128 amount1Min, bytes hookData"
  ),
  // 0x02
  [2 /* CL_MINT_POSITION */]: parseAbiParameters([
    "PositionConfig positionConfig, uint128 liquidity, uint128 amount0Max, uint128 amount1Max, address owner, bytes hookData",
    ...ABI_STRUCT_POSITION_CONFIG
  ]),
  // 0x03
  [3 /* CL_BURN_POSITION */]: parseAbiParameters([
    "uint256 tokenId, PositionConfig config, uint128 amount0Min, uint128 amount1Min, bytes hookData",
    ...ABI_STRUCT_POSITION_CONFIG
  ]),
  // 0x04
  [4 /* CL_INCREASE_LIQUIDITY_FROM_DELTAS */]: parseAbiParameters([
    "uint256 tokenId, uint128 amount0Max, uint128 amount1Max, bytes hookData"
  ]),
  // 0x05
  [5 /* CL_MINT_POSITION_FROM_DELTAS */]: parseAbiParameters([
    "PoolKey poolKey, int24 tickLower, int24 tickUpper, uint128 amount0Max, uint128 amount1Max, address owner, bytes hookData",
    ...ABI_STRUCT_POOL_KEY
  ]),
  // 0x06
  [6 /* CL_SWAP_EXACT_IN_SINGLE */]: parseAbiParameters([
    "CLSwapExactInputSingleParams params",
    ...ABI_STRUCT_CL_SWAP_EXACT_INPUT_SINGLE_PARAMS
  ]),
  // 0x07
  [7 /* CL_SWAP_EXACT_IN */]: parseAbiParameters([
    "CLSwapExactInputParams params",
    ...ABI_STRUCT_CL_SWAP_EXACT_INPUT_PARAMS
  ]),
  // 0x08
  [8 /* CL_SWAP_EXACT_OUT_SINGLE */]: parseAbiParameters([
    "CLSwapExactOutputSingleParams params",
    ...ABI_STRUCT_CL_SWAP_EXACT_OUTPUT_SINGLE_PARAMS
  ]),
  // 0x09
  [9 /* CL_SWAP_EXACT_OUT */]: parseAbiParameters([
    "CLSwapExactOutputParams params",
    ...ABI_STRUCT_CL_SWAP_EXACT_OUTPUT_PARAMS
  ]),
  // [ACTIONS.CL_DONATE]: parseAbiParameters('NOT SUPPORTED'),
  // 0x0b
  [11 /* SETTLE */]: parseAbiParameters("address currency, uint256 amount, bool payerIsUser"),
  // 0x0c
  [12 /* SETTLE_ALL */]: parseAbiParameters("address currency, uint256 maxAmount"),
  // 0x0d
  [13 /* SETTLE_PAIR */]: parseAbiParameters("address currency0, address currency1"),
  // 0x0e
  [14 /* TAKE */]: parseAbiParameters("address currency, address recipient, uint256 amount"),
  // 0x0f
  [15 /* TAKE_ALL */]: parseAbiParameters("address currency, uint256 minAmount"),
  // 0x10
  [16 /* TAKE_PORTION */]: parseAbiParameters("address currency, address recipient, uint256 bips"),
  // 0x11
  [17 /* TAKE_PAIR */]: parseAbiParameters("address currency0, address currency1, address to"),
  // 0x12
  [18 /* CLOSE_CURRENCY */]: parseAbiParameters("address currency"),
  // 0x13
  [19 /* CLEAR_OR_TAKE */]: parseAbiParameters("address currency, uint256 amountMax"),
  // 0x14
  [20 /* SWEEP */]: parseAbiParameters("address currency, address to"),
  // 0x15
  [21 /* WRAP */]: parseAbiParameters("uint256 amount"),
  // 0x16
  [22 /* UNWRAP */]: parseAbiParameters("uint256 amount"),
  // 0x17
  // [ACTIONS.MINT_6909]: parseAbiParameters('NOT SUPPORTED'),
  // 0x18
  // [ACTIONS.BURN_6909]: parseAbiParameters('NOT SUPPORTED'),
  // 0x19
  [25 /* BIN_ADD_LIQUIDITY */]: parseAbiParameters([
    "BinAddLiquidityParams params",
    ...ABI_STRUCT_BIN_ADD_LIQUIDITY_PARAMS
  ]),
  // 0x1a
  [26 /* BIN_REMOVE_LIQUIDITY */]: parseAbiParameters([
    "BinRemoveLiquidityParams params",
    ...ABI_STRUCT_BIN_REMOVE_LIQUIDITY_PARAMS
  ]),
  // 0x1b
  [27 /* BIN_ADD_LIQUIDITY_FROM_DELTAS */]: parseAbiParameters([
    "BinAddLiquidityFromDeltasParams params",
    ...ABI_STRUCT_BIN_ADD_LIQUIDITY_FROM_DELTAS_PARAMS
  ]),
  // 0x1c
  [28 /* BIN_SWAP_EXACT_IN_SINGLE */]: parseAbiParameters([
    "BinSwapExactInputSingleParams params",
    ...ABI_STRUCT_BIN_SWAP_EXACT_INPUT_SINGLE_PARAMS
  ]),
  // 0x1d
  [29 /* BIN_SWAP_EXACT_IN */]: parseAbiParameters([
    "BinSwapExactInputParams params",
    ...ABI_STRUCT_BIN_SWAP_EXACT_INPUT_PARAMS
  ]),
  // 0x1e
  [30 /* BIN_SWAP_EXACT_OUT_SINGLE */]: parseAbiParameters([
    "BinSwapExactOutputSingleParams params",
    ...ABI_STRUCT_BIN_SWAP_EXACT_OUTPUT_SINGLE_PARAMS
  ]),
  // 0x1f
  [31 /* BIN_SWAP_EXACT_OUT */]: parseAbiParameters([
...
var INFINITY_SUPPORTED_CHAINS = [ChainId.BSC, ChainId.BSC_TESTNET, ChainId.SEPOLIA, ChainId.BASE];
...
var ActionsPlanner = class {
  ...
  static decode(calls) {
    ...
    for (let i = 0; i < actionsSize; i++) {
      const action = Number(sliceHex(actions_, i, i + 1));
      actions.push(action);
    }
    const plans = [];
    for (let i = 0; i < actionsSize; i++) {
  ...
  finalizeModifyLiquidityWithCloseWrap(poolKey, wrapAddress, recipient) {
    ...
    this.add(14 /* TAKE */, [zeroAddress, ACTION_CONSTANTS.ADDRESS_THIS, ACTION_CONSTANTS.OPEN_DELTA]);
    this.add(18 /* CLOSE_CURRENCY */, [poolKey.currency1]);
  ...
  finalizeModifyLiquidityWithCloseNative(poolKey, sweepRecipient) {
    invariant12(poolKey.currency0 === zeroAddress, "currency0 must be native currency");
    this.add(18 /* CLOSE_CURRENCY */, [poolKey.currency0]);
    this.add(18 /* CLOSE_CURRENCY */, [poolKey.currency1]);
  ...
  finalizeSwap(inputCurrency, outputCurrency, takeRecipient) {
    if (isAddressEqual(takeRecipient, ACTION_CONSTANTS.MSG_SENDER)) {
      this.add(12 /* SETTLE_ALL */, [inputCurrency, maxUint256]);
...
var decodeHooksRegistration = (encoded) => {
  ...
  invariant12(registration >= 0 && registration <= 16383, "Invalid hooks registration");
...
var mulShiftRoundDown = (x, y, offset) => {
  ...
  if (prod1 !== 0n) {
    invariant12(offset < 1n << offset, "MUL_SHIFT_OVERFLOW");
...
var _getEndOfDivRoundDown = (x, y, denominator, prod0, prod1) => {
  ...
  invariant12(prod1 < denominator, "MUL_DIV_OVERFLOW");
...
var binPoolMintCalldata = (key, params, hookData) => {
  invariant12(params.liquidityConfigs.length > 0, "LIQUIDITY_CONFIGS_EMPTY");
...
var encodeBinPositionManagerRemoveLiquidityCalldata = (params, deadline) => {
  ...
  if (wrapAddress && !isAddressEqual(wrapAddress, zeroAddress)) {
    invariant12(recipient && isAddress(recipient), "Invalid Wrap Config");
...
var createBinPool = ({
  ...
  invariant12(Number.isInteger(lpFee) && BigInt(lpFee) >= 0 && BigInt(lpFee) <= TEN_PERCENT_FEE, "SWAP_FEE");
  invariant12(
    protocolFees.every(
  ...
  invariant12(Number.isInteger(binStep) && BigInt(binStep) >= MIN_BIN_STEP && BigInt(binStep) <= MAX_BIN_STEP, "BIN_STEP");
  invariant12(Number.isInteger(activeId), "ACTIVE_ID");
...
var getPriceX128FromId = (activeId, binStep) => {
  ...
  invariant12(exponent < Q20, "EXPONENT");
  let squared = base;
  let result = SCALE;
  if (base > maxUint128) {
...
var getIdFromCurrencyPrice = (price, binStep) => {
  return getIdFromPrice(
    Number(new BigNumber2(price.numerator.toString()).div(price.denominator.toString()).toFixed()),
    binStep
  );
};
...
var getNextNonEmptyBin = (binPool, activeId, swapForY) => {
  invariant12(binPool.tree, "EMPTY_BIN_POOL");
...
var swap = (binPool, amountIn, swapForY) => {
  invariant12(amountIn > 0n, "INSUFFICIENT_AMOUNT_IN");
...
var encodeCLPositionManagerDecreaseLiquidityCalldata = ({
  ...
  let calls;
  if (wrapAddress && !isAddressEqual(wrapAddress, zeroAddress)) {
    invariant12(recipient && !isAddressEqual(recipient, zeroAddress), "Invalid Wrap Config");
...
var Pool = class {
  ...
  constructor({
    ...
    invariant12(Number.isInteger(fee) && fee < 1e6, "FEE");
   ...
   */
  get token0Price() {
    this._token0Price = this._token0Price ?? new Price(this.token0, this.token1, Q192, this.sqrtRatioX96 * this.sqrtRatioX96);
   ...
   */
  get token1Price() {
    this._token1Price = this._token1Price ?? new Price(this.token1, this.token0, this.sqrtRatioX96 * this.sqrtRatioX96, Q192);
   ...
   */
  priceOf(token) {
    invariant12(this.involvesToken(token), "TOKEN");
  ...
  async getOutputAmount(inputAmount, sqrtPriceLimitX96) {
    invariant12(this.involvesToken(inputAmount.currency), "TOKEN");
  ...
  async getInputAmount(outputAmount, sqrtPriceLimitX96) {
    invariant12(outputAmount.currency.isToken && this.involvesToken(outputAmount.currency), "TOKEN");
  ...
  async getInputAmountByExactOut(outputAmount, sqrtPriceLimitX96) {
    ...
    invariant12(amountSpecifiedRemaining === 0n, "INSUFFICIENT_LIQUIDITY");
    const inputToken = zeroForOne ? this.token0 : this.token1;
    return [
      CurrencyAmount.fromRawAmount(inputToken, inputAmount),
      new Pool({
  ...
  async swap(zeroForOne, amountSpecified, _sqrtPriceLimitX96) {
    const sqrtPriceLimitX96 = _sqrtPriceLimitX96 ?? (zeroForOne ? TickMath.MIN_SQRT_RATIO + ONE : TickMath.MAX_SQRT_RATIO - ONE);
    if (zeroForOne) {
      invariant12(sqrtPriceLimitX96 > TickMath.MIN_SQRT_RATIO, "RATIO_MIN");
      invariant12(sqrtPriceLimitX96 < this.sqrtRatioX96, "RATIO_CURRENT");
    } else {
      invariant12(sqrtPriceLimitX96 < TickMath.MAX_SQRT_RATIO, "RATIO_MAX");
      invariant12(sqrtPriceLimitX96 > this.sqrtRatioX96, "RATIO_CURRENT");
    }
